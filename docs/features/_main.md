...
## Карта Модулей
- **Управление Табами:** `features/tabs.md` — Цвета, Drag & Drop, Smart Restart (↻), Middle-click, Utils-индикация.
- **Research (AI Чат):** `features/research.md` — Интеграция Gemini, система чатов, работа с выделением.
...
- **Claude Сессии:** `features/claude-sessions.md` — Управление через InfoPanel, Claude Runner, Smart Fork.
...
- **Данные:** `knowledge/fix-data-persistence.md` — Persistence, Dynamic Styles.
