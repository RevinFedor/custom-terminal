...
- **AI Prompts:** Разделены на два типа:
    - **System (Research):** Специальный промпт для функции "Research Selection". Подставляется перед выделенным текстом. Можно редактировать или сбросить к дефолтному.
    - **User:** Кастомные шаблоны для вставки в терминал или AI чаты.
- **Визуальное разделение:** В UI системные промпты выделены голубой рамкой и меткой "System".
- **Интеграция:** 
