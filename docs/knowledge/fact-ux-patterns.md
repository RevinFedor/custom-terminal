...
### Мотивация
Разделение "пользовательского" и "программного" закрытия позволяет:
1. Защитить пользователя от случайного закрытия активного процесса (диалог при ручном `Cmd+W`).
2. Обеспечить гладкую работу автоматизации без визуальных артефактов.
