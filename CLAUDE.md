...
- **Completion Reliability:** [`fix-mcp-completion-reliability.md`](docs/knowledge/fix-mcp-completion-reliability.md) — детерминированное завершение через `turn_duration` и Deferred Re-check.
