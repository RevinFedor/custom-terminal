...
- **Orchestration Timeline:** [`fact-timeline.md`](docs/knowledge/fact-timeline.md) — визуализация сложных цепочек агентов (Tree View, группировка раундов, абсолютное наложение).
