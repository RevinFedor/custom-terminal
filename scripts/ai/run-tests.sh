...
TESTS=(
  ...
  "Мусор при переключении|При переключении между проектами терминал иногда показывает мусор вместо текста ???|ui-ux-stability.md,terminal-core.md"
  "Зеленая точка моргает|Почему при быстром переключении вкладок зеленая точка running моргает и пропадает ???|ui-ux-stability.md,terminal-core.md"
