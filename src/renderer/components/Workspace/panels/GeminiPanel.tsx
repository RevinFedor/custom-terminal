            ...
            {apiCalls.map((call: any) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Mini-timeline: [N msg] for turns, thin markers for compact/plan */}
                      ...
                      {meta.segments.map((seg, si) => {
                        if (seg.type === 'turns') {
                          return <span key={si} style={{
                            fontSize: '9px', color: 'rgba(166, 227, 161, 0.7)',
                            backgroundColor: 'rgba(166, 227, 161, 0.1)',
                            padding: '0 4px', borderRadius: '2px', border: '1px solid rgba(166, 227, 161, 0.2)',
                          }}>{seg.count} msg</span>;
